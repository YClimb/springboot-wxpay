package com.demo.weixin.sdk.constants;
...
public class WXPayConstants {
     ...
     * 场景：刷卡支付
     */
    public static final String MICROPAY_URL_SUFFIX     = "/mybatis/mapper/pay/micropay";
    /**
     * 作用：统一下单<br>
     * 场景：公共号支付、扫码支付、APP支付
     */
    public static final String UNIFIEDORDER_URL_SUFFIX = "/mybatis/mapper/pay/unifiedorder";
    /**
     * 作用：查询订单<br>
     * 场景：刷卡支付、公共号支付、扫码支付、APP支付
     */
    public static final String ORDERQUERY_URL_SUFFIX   = "/mybatis/mapper/pay/orderquery";
    /**
     * 作用：撤销订单<br>
     * 场景：刷卡支付<br>
     * 其他：需要证书
     ...
     * 场景：公共号支付、扫码支付、APP支付
     */
    public static final String CLOSEORDER_URL_SUFFIX   = "/mybatis/mapper/pay/closeorder";
    /**
     * 作用：申请退款<br>
     ...
     * 场景：刷卡支付、公共号支付、扫码支付、APP支付
     */
    public static final String REFUNDQUERY_URL_SUFFIX  = "/mybatis/mapper/pay/refundquery";
    /**
     * 作用：对账单下载<br>
     * 场景：刷卡支付、公共号支付、扫码支付、APP支付<br>
     ...
     */
    public static final String DOWNLOADBILL_URL_SUFFIX = "/mybatis/mapper/pay/downloadbill";
    /**
     * 作用：交易保障<br>
     * 场景：刷卡支付、公共号支付、扫码支付、APP支付
     */
